package com.coding.pan.cache.caffeine.test;

import cn.hutool.core.lang.Assert;
import com.coding.pan.cache.caffeine.test.config.CaffeineCacheConfig;
import com.coding.pan.cache.caffeine.test.instance.CacheAnnotationTester;
...
public class CaffeineCacheTest {
    ...
    public void caffeineCacheAnnotationTest() {
        for (int i = 0; i < 2; i++) {
            cacheAnnotationTester.testCacheable("coding");
        }
    }
